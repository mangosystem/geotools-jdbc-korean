...
public class CubridPSDialect extends PreparedStatementSQLDialect {

    private CubridDialect delegate;

    private WKBWriter wkbWriter = new WKBWriter();

    public CubridPSDialect(JDBCDataStore store, CubridDialect delegate) {
        super(store);
    ...
    public PreparedFilterToSQL createPreparedFilterToSQL() {
        CubridPSFilterToSql fts = new CubridPSFilterToSql(this);
