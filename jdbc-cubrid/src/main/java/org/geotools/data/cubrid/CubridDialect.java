...
public class CubridDialect extends BasicSQLDialect {

    static final Version V_9_1_0 = new Version("9.1.0");
    ...
    public FilterToSQL createFilterToSQL() {
        CubridFilterToSQL sql = new CubridFilterToSQL(this);
